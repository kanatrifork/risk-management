...
function DeleteConfirmation(clientAPI) {
  return clientAPI.executeAction('/RiskMobile/Actions/DeleteConfirmation.action').then(result => {
    if (result.data) {
      return clientAPI.executeAction('/RiskMobile/Actions/RiskManagementService/Mitigations/Mitigations_DeleteEntity.action').then(success => Promise.resolve(success), failure => Promise.reject('Delete entity failed ' + failure));
    } else {
      return Promise.reject('User Deferred');
    }
  });
...
function DeleteConfirmation(clientAPI) {
  return clientAPI.executeAction('/RiskMobile/Actions/DeleteConfirmation.action').then(result => {
    if (result.data) {
      return clientAPI.executeAction('/RiskMobile/Actions/RiskManagementService/Risks/Risks_DeleteEntity.action').then(success => Promise.resolve(success), failure => Promise.reject('Delete entity failed ' + failure));
    } else {
      return Promise.reject('User Deferred');
    }
  });
...
module.exports = {"_Name":"RiskMobile","Version":"/RiskMobile/Globals/Application/AppDefinition_Version.global","MainPage":"/RiskMobile/Pages/Main.page","OnLaunch":"/RiskMobile/Rules/Service/Initialize.js","OnWillUpdate":"/RiskMobile/Rules/Application/OnWillUpdate.js","OnDidUpdate":"/RiskMobile/Rules/Service/Initialize.js","Styles":"/RiskMobile/Styles/Styles.less","Localization":"/RiskMobile/i18n/i18n.properties","_SchemaVersion":"26.3","StyleSheets":{"Styles":{"css":"/RiskMobile/Styles/Styles.css","ios":"/RiskMobile/Styles/Styles.nss","android":"/RiskMobile/Styles/Styles.json"}}}
...
module.exports = {"ParentLink":{"Property":"risks","Target":{"EntitySet":"Mitigations","ReadLink":"{@odata.readLink}"}},"OnFailure":"/RiskMobile/Actions/CreateEntityFailureMessage.action","OnSuccess":"/RiskMobile/Actions/CreateEntitySuccessMessage.action","Properties":{"title":"#Page:Mitigations_CreateRisks/#Control:title/#Value","prio":"#Page:Mitigations_CreateRisks/#Control:prio/#Value","descr":"#Page:Mitigations_CreateRisks/#Control:descr/#Value","impact":"#Page:Mitigations_CreateRisks/#Control:impact/#Value","criticality":"#Page:Mitigations_CreateRisks/#Control:criticality/#Value","supplier_BusinessPartner":"#Page:Mitigations_CreateRisks/#Control:supplier_BusinessPartner/#SelectedValue"},"Target":{"EntitySet":"Risks","Service":"/RiskMobile/Services/RiskManagementService.service"},"ActionResult":{"_Name":"create"},"_Type":"Action.Type.ODataService.CreateRelatedEntity"}
...
module.exports = {"CreateLinks":[],"OnFailure":"/RiskMobile/Actions/CreateEntityFailureMessage.action","OnSuccess":"/RiskMobile/Actions/CreateEntitySuccessMessage.action","Properties":{"title":"#Page:Risks_Create/#Control:title/#Value","prio":"#Page:Risks_Create/#Control:prio/#Value","descr":"#Page:Risks_Create/#Control:descr/#Value","impact":"#Page:Risks_Create/#Control:impact/#Value","criticality":"#Page:Risks_Create/#Control:criticality/#Value","supplier_BusinessPartner":"#Page:Risks_Create/#Control:supplier_BusinessPartner/#SelectedValue"},"Target":{"EntitySet":"Risks","Service":"/RiskMobile/Services/RiskManagementService.service"},"ActionResult":{"_Name":"create"},"_Type":"Action.Type.ODataService.CreateEntity"}
